...
const SendVerificationMail = async (user, res) => {
  ...
  const resp = await resend.emails.send({
    ...
    to: ["ashish.ranjanbca2021175@imsnoida.com", "ashya2616@gmail.com"],
